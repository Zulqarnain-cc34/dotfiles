...
mp.add_key_binding("`", "set-end-timestamp", set_end_timestamp)
...
mp.add_key_binding("ctrl+a", "cut-audio-fragment", cut_audio_fragment)
mp.add_key_binding("ctrl+x", "cut-video-fragment", cut_video_fragment)
mp.add_key_binding("ctrl+s", "cut-video-fragment-with-subtitles", cut_video_fragment_with_subtitles)
